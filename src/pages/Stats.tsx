    ...
    <>
      <header className="bg-[#131313] text-on-surface font-headline font-bold uppercase sticky top-0 z-40 bg-opacity-90 backdrop-blur-md">
        <div className="flex justify-between items-center w-full px-6 py-4">
          <h1 className="text-xl tracking-tight">Financial Overview</h1>
      ...
      <main className="px-6 mt-4 space-y-6">
        <section className="bg-surface-container-low p-6 rounded-2xl relative overflow-hidden shadow-lg border border-outline-variant/20">
          <div className="flex justify-between items-start mb-2 relative z-10">
            <p className="font-label text-xs font-bold uppercase tracking-[0.1em] opacity-80 pt-1 text-on-surface-variant">Net Margin (YTD)</p>
          ...
          <div className="mt-4 flex items-center justify-between relative z-10">
            <span className="bg-surface-container-highest px-3 py-1.5 rounded-full text-[12px] font-bold text-on-surface">Margin: {marginPercentage}%</span>
          </div>
        </section>

        <section className="grid grid-cols-2 gap-4">
          <div className="bg-surface-container-low p-4 rounded-2xl">
            <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest pt-1">Avg Cost/Gram</p>
            <p className="font-headline text-xl text-on-surface font-bold">${costPerGram}</p>
          </div>
          <div className="bg-surface-container-low p-4 rounded-2xl">
            <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest pt-1">Total Mined</p>
          ...
          <div className="bg-surface-container-low p-6 rounded-2xl col-span-2 space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="font-headline text-sm font-bold uppercase tracking-widest text-on-surface-variant">Data Operations</h3>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <Link to="/sales" className="bg-surface-container-highest p-4 rounded-xl flex flex-col items-center gap-2 hover:bg-surface-bright transition-colors decoration-transparent text-primary">
                <Icon name="sell" />
                <span className="font-headline text-[10px] font-bold uppercase tracking-wider text-center">Sales<br/>Registry</span>
              </Link>
              <Link to="/expenses" className="bg-surface-container-highest p-4 rounded-xl flex flex-col items-center gap-2 hover:bg-surface-bright transition-colors decoration-transparent text-on-surface">
                <Icon name="payments" />
                <span className="font-headline text-[10px] font-bold uppercase tracking-wider text-center">Expense<br/>Log</span>
              </Link>
            </div>
          </div>
        </section>
