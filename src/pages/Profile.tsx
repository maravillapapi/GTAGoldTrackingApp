    ...
    <>
      <header className="bg-[#131313] text-on-surface font-headline font-bold uppercase sticky top-0 z-40 bg-opacity-90 backdrop-blur-md">
        <div className="flex justify-between items-center w-full px-6 py-4">
          <h1 className="text-xl tracking-tight">Access Control</h1>
      ...
      <main className="px-6 mt-4 space-y-6">
        <section className="bg-surface-container-low p-6 rounded-2xl border border-outline/10 text-center">
          ...
          <h2 className="font-headline text-lg font-bold">XAU Architect</h2>
          <p className="text-xs text-on-surface-variant font-bold uppercase tracking-widest mt-1">System Authenticated</p>
        </section>

        <section className="space-y-4">
          <h3 className="font-headline text-sm font-bold uppercase tracking-widest text-on-surface-variant">Role Simulator</h3>
          <p className="text-[10px] text-on-surface-variant uppercase tracking-widest">Select an active role to test system constraints.</p>
            ...
            {(['ADMIN', 'SUPERVISOR', 'OBSERVER'] as const).map(r => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-headline font-bold uppercase tracking-widest text-sm pt-1">{r}</span>
                </div>
